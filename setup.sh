...
then
    ...
    curl -u ${GITHUB_USERNAME} https://api.github.com/orgs/:senseobservationsystems/repos -d '{"name":"'${GITHUB_REPOS}'"}'
else
    echo "Using existing repository"
    read -p "Type the repository name: " GITHUB_REPOS
fi

git remote set-url origin https://github.com/senseobservationsystems/${GITHUB_REPOS}.git
